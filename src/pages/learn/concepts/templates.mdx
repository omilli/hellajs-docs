...
Use the `raw:` prefix to bypass HellaJS's automatic reactivity transformation and pass static values from functions.
    ...
    <div>
      ...
      */}
      ...
      {/* 
          ...
          class: staticFunction()
      */}
      <button raw:class={staticFunction()}>Raw Value</button>
    </div>
  );
};
```
