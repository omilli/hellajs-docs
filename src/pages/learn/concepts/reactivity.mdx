...
[Signals](/reference/core/signal) and [computed values](/reference/core/computed) automatically detect changes using deep equality comparison for objects and arrays. This means you can pass new instances with the same content without triggering unnecessary updates.
