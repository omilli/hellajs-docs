...
List items are automatically cleaned up through the [nodeRegistry](/reference/dom/noderegistry) when removed from the DOM. No manual cleanup needed for reactive effects or event handlers on list elements.
