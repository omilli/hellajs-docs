...
Route patterns with `:param` placeholders are dynamically substituted with values from the params object. You can pass either a pattern with placeholders or a final URL path.
