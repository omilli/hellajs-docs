...
The development experience with JSX is familiar to anyone coming from React or Solid.
...
Instead of a virtual DOM, HellaJS attaches effects directly to elements which are automatically cleaned after they are removed from the DOM.
