...
This isn't a guide to reactivity in general, but rather how HellaJS implements it. If you're new to reactivity, check out the some other resources.

<div class="mt-6">
  <Aside type="note" title="Note">
    <p>
      The core package is a modified fork of `Alien Signals`. Credit to that fine work!
    </p>
  </Aside>
</div>
